...
import {
  ...
  extractAnthropicTextDeltaFromChunk,
  extractAnthropicThinkingDeltaFromChunk,
  extractAnthropicToolUseDeltaFromChunk,
  extractChatDeltaTextFromChunk,
  extractChatFinishReason,
  extractChatReasoningDeltaFromChunk,
  extractChatToolCallDeltasFromChunk,
  extractCompletionDeltaTextFromChunk,
  extractLegacyCompletionText,
  extractResponsesReasoningDelta,
  extractResponsesReasoningText,
  extractResponsesTextDelta,
  extractSseData
} from "@/lib/compat-stream-utils";
